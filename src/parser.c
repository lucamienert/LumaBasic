...
ast_t *
parse(parser_t *parser, scope_t *scope)
{
    return parse_statements(parser, scope);
}

ast_t *
parse_statement(parser_t *parser, scope_t *scope)
{
...
ast_t *
parse_statements(parser_t *parser, scope_t *scope)
{
...
ast_t *
parse_expr(parser_t *parser, scope_t *scope)
{
    switch (parser->current_token->type)
    {
...
ast_t *
parser_parse_factor(parser_t *parser, scope_t *scope)
{
}

ast_t *
parser_parse_term(parser_t *parser, scope_t *scope)
{
}

ast_t *
parse_function_call(parser_t *parser, scope_t *scope)
{
...
ast_t *
parse_variable_definition(parser_t *parser, scope_t *scope)
{
    eat(parser, TOKEN_ID);
...
ast_t *
parse_function_definition(parser_t *parser, scope_t *scope)
{
...
ast_t *
parse_variable(parser_t *parser, scope_t *scope)
{
...
ast_t *
parse_string(parser_t *parser, scope_t *scope)
{
...
ast_t *
parse_id(parser_t *parser, scope_t *scope)
{
    ...
    if (strcmp(parser->current_token->value, "fun") == 0)
    {
