...
ast_t *
add_function_definition(scope_t *scope, ast_t *ast)
{
...
ast_t *
get_function_definition(scope_t *scope, const char *name)
{
...
ast_t *
add_variable_definition(scope_t *scope, ast_t *ast)
{
...
ast_t *
get_variable_definition(scope_t *scope, const char *name)
{
