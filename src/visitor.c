...
ast_t *
visit(visitor_t *visitor, ast_t *node)
{
    switch (node->type)
    {
...
ast_t *
visit_variable_definition(visitor_t *visitor, ast_t *node)
{
...
ast_t *
visit_function_definition(visitor_t *visitor, ast_t *node)
{
...
ast_t *
visit_variable(visitor_t *visitor, ast_t *node)
{
...
ast_t *
visit_function_call(visitor_t *visitor, ast_t *node)
{
...
ast_t *
visit_string(visitor_t *visitor, ast_t *node)
{
    return node;
}

ast_t *
visit_compound(visitor_t *visitor, ast_t *node)
{
